...
class Kecamatan_M extends CI_Model
{
    ...
    public function get_all_data_by_id($id)
    {
        //Mendefinikan variabel
        $response = array();
        $data = $this->db->query("select * from m_ikecamatan where id_kabkota =  '$id' order by nama_kecamatan ");
    ...
    public function get_all_data()
    {
        //Mendefinikan variabel
        $response = array();
        $data = $this->db->query("select * from m_ikecamatan order by nama_kecamatan");
        $num_rows = $data->num_rows();
